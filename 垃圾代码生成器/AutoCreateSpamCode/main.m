...
NSString *getClassPrefixString(){
    ...
    NSString *string = @"Account_Class_";
    NSArray *strings = @[@"eSports_Class_",@"tr_Class_",@"ttSports_Class_",@"tySports_Class_",@"yuSports_Class_",@"yiSports_Class_",@"uoSports_Class_",@"eaSports_Class_",@"esSports_Class_",@"dwSports_Class_",@"fSportsq_Class_",@"geSports_Class_",@"ehSports_Class_",@"jwSports_Class_",@"wkSports_Class_",@"qfmydong",@"rvmyhost",@"tvyourAction",@"wbhim",@"sqdrand",@"qsBs",@"awad",@"wddsa",@"qdjd_Class_",@"edhao_Class_",@"wBMG_A14_",@"qQPG_A13_",@"qFAG_Class_",@"wWME_Class_",@"eTPY_A15_",@"wUAD_Class_",@"qMSG_A14_",@"qMSB_Class_",@"qNSG_A11_",@"qOKG_A15_",@"wSBG_A13_",@"eSNK_Class_",@"qSSW_A12_"];
...
NSString *getMethodPrefixString(){
    ...
    NSString *string = @"XH_method_";
    NSArray *strings = @[@"Sports_methods_",@"bag_X11_",@"bmg_X12_",@"qpg_method_",@"fag_method_",@"wme_X13_",@"tpy_method_",@"uad_X15_",@"msg_X13_",@"msb_X14_",@"nsg_method_",@"okg_X12_",@"sbg_method_",@"snk_X15_",@"ssw_X11_"];
    string = strings[(int)(arc4random() % strings.count)];
    return string;
}
